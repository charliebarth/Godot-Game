...
//     base: Base<Line2D>,
//     metal: Option<Gd<Node2D>>, // the metal has to have the MetalObject trait
...
//             self.base_mut()
//                 .set_default_color(Color::from_rgb(0.2, 0.4, blue).with_alpha(1.0));
//             self.base_mut().set_width(2.0);
//         }
//     }

//     pub fn initialize_fields(&mut self, metal: Gd<Node2D>, player: Gd<CharacterBody2D>) {
...
//     pub fn get_metal(&self) -> Option<Gd<Node2D>> {
//         self.metal.clone()
//     }
// }
