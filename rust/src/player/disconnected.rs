...
/// The Disconnected class is responsible for displaying a timer and removing the player from the
...
/// It will be disabled if the device reconnects before the timer runs out.
#[derive(GodotClass)]
#[class(base=Label)]
